...
第六篇的 Dream 是記憶管理員——合併碎片、整理重疊、偵測矛盾。它的工作是讓記憶庫保持乾淨。
...
選到種子之後，沿著記憶的連結網（第四篇和第五篇講的 Link Graph）隨機漫遊幾步，把沿途碰到的記憶也撈上來。
...
漫遊結束後，素材還沒收工。系統會另外挑一張卡混進去——這次不是沿連結找的，是反過來找：拿種子的向量，在全庫的小卡片（限 200 字以內）裡找一張**離種子最遠**的，找到就塞進素材，跟種子、漫遊撈到的那些擺在一起。
...
雨聲裡混著她笑罵的聲音（想翻全文用 recall_dream，大約 4 小時後就散）
```
